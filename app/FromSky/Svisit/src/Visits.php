...
namespace App\FromSky\Svisit\src;

use App\FromSky\Svisit\src\Models\Visit;
use App\FromSky\Svisit\src\Traits\{Lists, Periods, Record, Setters};
...
class Visits
{
    ...
    {
        $connections = [
            'redis' => \App\FromSky\Svisit\src\DataEngines\RedisEngine::class,
            'eloquent' => \App\FromSky\Svisit\src\DataEngines\EloquentEngine::class
        ];
     ...
     * @param $method
     * @param string $args
     * @return \App\FromSky\Svisit\Reset
     */
