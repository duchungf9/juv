...
class ImgHelper
{
    ...
    {
        $this->path_repository = config('fromSky.admin.path.img_repository');
        $this->path_cache      = config('fromSky.admin.path.img_save');
        $this->cache_time      = config('fromSky.image.cache_time');
        $this->defaults        = config('fromSky.image.defaults');
        $this->size_limit      = config('fromSky.image.size_limit');
    }
