...
use App\FromSky\DomainLayer\Store\Discounts\DiscountBuilder;
use App\FromSky\DomainLayer\Store\Discounts\DiscountPresenter;
...
class Discount extends Model
{
	...
	*/
	...
	{
		return $this->hasMany('App\Model\Order', 'discount_code', 'code');
	}

    public function discount_type()
    {
        return $this->belongsTo('App\Model\Template', 'type', 'value');
    }
