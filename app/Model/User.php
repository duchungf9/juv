...
use App\FromSky\Notifications\UserResetPasswordNotification as UserResetPasswordNotification;

use App\FromSky\Permission\GFEntrustUserTrait;
use App\FromSky\DomainLayer\User\UserPresenter;
...
class User extends Authenticatable
{
    ...
    */
    ...
    public function identities() {
        return $this->hasMany('App\Model\SocialAccount');
    }
