    ...
    <div class="w-full mt-[56px]">
        <div class="container w-full mx-auto">
            <div class="header mb-[20px] pt-[20px] border-b-[1px] hidden lg:block">
                <h1 class="mb-[16px] text-[32px] leading-[37px] text-[#202124] font-bold">{{$categoryParent->title}}</h1>
                <ul class="flex">
            ...
            <div class="flex items-center py-[16px] px-[20px] lg:hidden overflow-auto">
                ...
                <a href="{{$categoryParent->getPermalink()}}" title="{{$categoryParent->title}}" class="text-sm leading-[18px] font-bold text-red whitespace-nowrap">{{$categoryParent->title}}</a>
                <a href="{{$category->getPermalink()}}" title="{{$category->title}}" class="text-sm leading-[18px] font-bold text-[#3D4043] pl-[20px] whitespace-nowrap">{{$category->title}}</a>
            </div>
                                ...
                                <div class="flex flex-wrap bg-[#F1F3F4]">
                                    ...
                                    <div class="lg:w-[440px] md:w-1/2 px-[35px] py-[20px] lg:p-[20px]">
                                        ...
                                        <h3 class="mb-[6px] lg:mb-[10px]">
                                            <a href="{{ $post->getPermalink() }}" class="lg:text-[32px] lg:leading-[40px] text-lg leading-[28px] text-[#202124] font-bold">{{ $post->title }}</a>
                                        </h3>
